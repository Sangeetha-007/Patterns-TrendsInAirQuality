...
What are the temporal patterns and trends in air quality indicators (CO, Non Metanic Hydrocarbons, Benzene, NOx, NO2) over the one-year recording period?



How well can a regression model predict hourly averaged concentrations of CO, Non Metanic Hydrocarbons, Benzene, NOx, and NO2 based on sensor responses? (Possible)

2. Justification

Understanding temporal patterns is crucial for unveiling variations and trends in air quality indicators. This exploration provides insights into daily, weekly, and seasonal fluctuations, aiding in policy planning and environmental management. The identification of long-term trends contributes to a comprehensive understanding of the dataset.


(Possible) This question addresses the fundamental objective of assessing regression model performance in predicting air quality indicators.

3. Data Sources

This is a UCI dataset.
Vito,Saverio. (2016). Air quality. UCI Machine Learning Repository. https://doi.org/10.24432/C5060Z.

4. Libraries potentially being used

Pandas:

For data manipulation and analysis, especially for handling time-series data, managing datasets, and performing exploratory data analysis (EDA).

NumPy:

For large, multi-dimensional arrays and matrices, and offers mathematical functions to operate on these arrays.
...
For data analysis and modeling, including regression models, model evaluation, and preprocessing tools.

5. EDA and summary statistics

The presence of -200 in some columns suggests missing or invalid data. It's important to handle these values appropriately, either by imputing missing data or using techniques suitable for dealing with such values.
